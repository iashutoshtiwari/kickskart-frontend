            ...
            <div className="relative aspect-square overflow-hidden rounded-lg bg-gray-100">
              ...
              {product.images.length > 1 && (
                <>
                  <button
                    onClick={prevImage}
                    className="absolute left-4 top-1/2 -translate-y-1/2 transform rounded-full bg-white bg-opacity-80 p-2 transition-all hover:bg-opacity-100"
                  >
                    <ChevronLeft className="h-5 w-5" />
                  </button>
                  <button
                    onClick={nextImage}
                    className="absolute right-4 top-1/2 -translate-y-1/2 transform rounded-full bg-white bg-opacity-80 p-2 transition-all hover:bg-opacity-100"
                  >
